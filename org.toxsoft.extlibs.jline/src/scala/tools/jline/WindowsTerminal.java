...
import scala.tools.jline.internal.*;
 ...
 * <em>java.io.tmpdir</em> System property), loading the library, and then calling the Win32 APIs
 * <a href="http://msdn.microsoft.com/library/default.asp? url=/library/en-us/dllproc/base/setconsolemode.asp">
 * SetConsoleMode</a> and
 * <a href="http://msdn.microsoft.com/library/default.asp? url=/library/en-us/dllproc/base/getconsolemode.asp">
 * GetConsoleMode</a> to disable character echoing.
 * <p/>
 * <p>
...
public class WindowsTerminal
  ...
  public WindowsTerminal()
    ...
    this.replayStream = new ReplayPrefixOneCharInputStream(
        Configuration.getString( JLINE_WINDOWS_TERMINAL_INPUT_ENCODING, Configuration.getFileEncoding() ) );
  ...
  public void setEchoEnabled( final boolean enabled ) {
    ...
    if( enabled ) {
      setConsoleMode( getConsoleMode() | ENABLE_ECHO_INPUT.code | ENABLE_LINE_INPUT.code | ENABLE_PROCESSED_INPUT.code
          | ENABLE_WINDOW_INPUT.code );
    }
    else {
      setConsoleMode( getConsoleMode() & ~(ENABLE_LINE_INPUT.code | ENABLE_ECHO_INPUT.code | ENABLE_PROCESSED_INPUT.code
          | ENABLE_WINDOW_INPUT.code) );
    }
  ...
  private boolean isSystemIn( final InputStream in )
      throws IOException {
    assert in != null;
  ...
  @Override
  public int readVirtualKey( final InputStream in )
      throws IOException {
  ...
  public static enum ConsoleMode {
     ...
     * events generated by mouse movement and button presses are placed in the input buffer. These events are discarded
     * by ReadFile or ReadConsole, even when this mode is enabled.
     */
    ...
    /**
     * This flag enables the user to use the mouse to select and edit text. To enable this option, use the OR to combine
  ...
  public static enum WindowsKey {
    ...
    /**
     * When following the SPECIAL_KEY_INDICATOR or NUMPAD_KEY_INDICATOR this character indicates that the delete key was
     * pressed.
     */
    DELETE_KEY( 83 ),
    ...
    /**
     * When following the SPECIAL_KEY_INDICATOR or NUMPAD_KEY_INDICATOR this character indicates that the page down key
     * was pressed.
     */
    PAGE_DOWN_KEY( 81 ),

    /**
     * When following the SPECIAL_KEY_INDICATOR or NUMPAD_KEY_INDICATOR this character indicates that the insert key was
     * pressed.
     */
    INSERT_KEY( 82 ),
